...
android {
    namespace = "app.nekolink.android"
    compileSdk = 35
    ...
    defaultConfig {
        ...
        minSdk = 26
        targetSdk = 35
        versionCode = (findProperty("nekoVersionCode") as String?)?.toIntOrNull() ?: 300
        versionName = (findProperty("nekoVersionName") as String?) ?: "0.3.0"
